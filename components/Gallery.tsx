...
const Gallery = ({projectImages, isGalleryOpen, closeGallery}:Gallery) => {
    ...
    return (
        <div 
            className={`${isGalleryOpen ? 'block' : 'hidden'} h-screen w-full absolute bg-black/80
            flex justify-center items-center`}
         >
            <button className='absolute md:right-12 right-[5%] top-6 p-2' onClick={closeGallery}>
            ...
            <GallerySlider projectImages={projectImages}/>
        </div>
    );
};
