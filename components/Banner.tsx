...
const Banner = ({ projects }: Props) => {
    ...
    return (
        <div className='flex flex-col md:grid md:grid-cols-4 grid-rows-4 md:grid-rows-none gap-2 md:gap-4 2xl:mt-0 md:w-[1350px] m-auto md:h-[85vh] h-[90vh] items-center'>
            <Link
                href={`/projects/${projects[7].id}`}
                className='h-[600px] md:w-full w-screen cursor-pointer relative duration-500 tile-1 hover:z-10 bg-center animate-fade animate-duration-1000 animate-ease-in animate-delay-300 animate-once'
            >
                <Image
                    src={projects[7].main_image}
            ...
            <Link
                ...
                className='bg-slate-400 relative h-[600px] w-full cursor-pointer hover:scale-110 hover:z-10 duration-500 tile-2 flex pr-4 md:pr-0 justify-end md:justify-center md:items-center items-end bg-center animate-fade animate-duration-1000 animate-ease-in animate-delay-500'
            >
                <Image
            ...
            <Link
                ...
                className='bg-slate-400 relative h-[600px] w-full cursor-pointer hover:scale-110 hover:z-10 duration-500 tile-2 flex pr-4 md:pr-0 justify-end md:justify-center md:items-center items-end  bg-center animate-fade animate-duration-1000 animate-ease-in animate-delay-700'
            >
                <Image
            ...
            <Link
                ...
                className='bg-slate-400 h-[600px] w-full cursor-pointer relative duration-500 hover:z-10 tile-3 bg-center animate-fade animate-duration-1000 animate-ease-in animate-delay-1000'
            >
                <Image
